(ns {{name}}.router
  ...
  (:require
   ...
   [{{name}}.events.second-level-get-config :refer [second_level_get_config]]
   [{{name}}.events.third-level-get-config :refer [third_level_get_config]]
   ...
   [{{name}}.events.first-level-get-config :refer [first_level_get_config]]
   [{{name}}.events.orders-history-get :refer [orders_history_get]]
   [{{name}}.events.order-get :refer [order_get]]
   [{{name}}.events.statuses-get :refer [statuses_get]]
   [{{name}}.events.managers-get :refer [managers_get]]
   [{{name}}.events.owners-get :refer [owners_get]]
