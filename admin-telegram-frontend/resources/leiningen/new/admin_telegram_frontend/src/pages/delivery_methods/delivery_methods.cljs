(ns {{name}}.pages.delivery-methods.delivery-methods
  (:require
   ["antd" :as antd]
   ...
   [{{name}}.events.delivery-provider-add :refer [delivery_provider_add]]
   [{{name}}.events.delivery-provider-del :refer [delivery_provider_del]]
