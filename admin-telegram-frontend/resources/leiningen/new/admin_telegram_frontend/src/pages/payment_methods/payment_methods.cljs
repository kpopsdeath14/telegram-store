(ns {{name}}.pages.payment-methods.payment-methods
  (:require
   ["antd" :as antd]
   ["@ant-design/icons" :as icons]
   [{{name}}.db :refer [app-state]]
   [{{name}}.events.payment-provider-add :refer [payment_provider_add]]
   [{{name}}.events.payment-provider-del :refer [payment_provider_del]]
   [{{name}}.events.payment-provider-validate :refer [payment_provider_validate]]
   [reagent.core :as reagent :refer [as-element]]
   [clojure.string :as string]
   [{{name}}.pages.payment-methods.modal-help :refer [modal_help]]
   )
  )
