(ns {{name}}.pages.managers.managers
  (:require
   ["antd" :as antd]
   ...
   [{{name}}.events.managers-set :refer [managers_set]]
   [{{name}}.events.managers-request-del :refer [managers_request_del]]
   [{{name}}.pages.managers.modal-help :refer [modal_help]]
   ))
