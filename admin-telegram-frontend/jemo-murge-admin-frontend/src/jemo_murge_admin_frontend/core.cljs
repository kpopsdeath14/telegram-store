(ns jemo-murge-admin-frontend.core
  (:require
   ["antd" :as antd]
   [reagent.dom :as d]
   [jemo-murge-admin-frontend.router :refer [routes]]
   [jemo-murge-admin-frontend.db :refer [app-state]]
   [jemo-murge-admin-frontend.viewes :refer [current-page]]
   [jemo-murge-admin-frontend.pages.header.header :refer [header]]
   [jemo-murge-admin-frontend.pages.login.login :refer [login_page]]
   [jemo-murge-admin-frontend.local-storage :as ls]

   [jemo-murge-admin-frontend.events.units-get :refer [units_get]]
   [jemo-murge-admin-frontend.events.filters-get :refer [filters_get]]
   ...
   [jemo-murge-admin-frontend.events.store-get :refer [store_get]]
