(ns jemo-murge-admin-frontend.pages.product.modal-picture-edit
  (:require
   ["antd" :as antd]
   [jemo-murge-admin-frontend.db :refer [app-state]]
   ["@ant-design/icons" :as icons]
   [reagent.core :as reagent :refer [as-element]]
   [jemo-murge-admin-frontend.api-uri-maker :refer [api_uri_maker image_uri_maker]]
   ...
   [jemo-murge-admin-frontend.events.product-image-delete :refer [product_image_delete]]
   ))
